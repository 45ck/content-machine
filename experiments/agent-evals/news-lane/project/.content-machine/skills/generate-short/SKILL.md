...
entrypoint: node ./node_modules/@45ck/content-machine/agent/run-tool.mjs generate-short
inputs:
  - name: topic
...
7. Render.
8. Review. Reject bad outputs instead of rebranding them as acceptable.
