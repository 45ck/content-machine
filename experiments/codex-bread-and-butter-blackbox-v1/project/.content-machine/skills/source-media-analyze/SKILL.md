...
entrypoint: node ./node_modules/@45ck/content-machine/agent/run-tool.mjs source-media-analyze
inputs:
  - name: mediaPath
...
```bash
cat experiments/codex-bread-and-butter-blackbox-v1/project/.content-machine/skills/source-media-analyze/examples/request.json | \
