...
entrypoint: node ./node_modules/@45ck/content-machine/agent/run-tool.mjs highlight-approval
inputs:
  - name: candidatesPath
...
```bash
cat experiments/codex-bread-and-butter-blackbox-v1/project/.content-machine/skills/highlight-approval/examples/request.json | \
  node ./node_modules/@45ck/content-machine/agent/run-tool.mjs highlight-approval
```
