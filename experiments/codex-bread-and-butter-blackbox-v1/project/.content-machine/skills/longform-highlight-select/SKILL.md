...
entrypoint: node ./node_modules/@45ck/content-machine/agent/run-tool.mjs longform-highlight-select
inputs:
  - name: timestampsPath
...
```bash
cat experiments/codex-bread-and-butter-blackbox-v1/project/.content-machine/skills/longform-highlight-select/examples/request.json | \
  node ./node_modules/@45ck/content-machine/agent/run-tool.mjs longform-highlight-select
```
