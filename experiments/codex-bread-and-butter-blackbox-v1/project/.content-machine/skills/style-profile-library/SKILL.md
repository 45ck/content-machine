...
entrypoint: node ./node_modules/@45ck/content-machine/agent/run-tool.mjs style-profile-library
inputs:
  - name: libraryPath
...
```bash
cat experiments/codex-bread-and-butter-blackbox-v1/project/.content-machine/skills/style-profile-library/examples/request.json | \
  node ./node_modules/@45ck/content-machine/agent/run-tool.mjs style-profile-library
```
