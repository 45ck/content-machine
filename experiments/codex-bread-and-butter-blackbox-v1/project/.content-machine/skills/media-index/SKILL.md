...
entrypoint: node ./node_modules/@45ck/content-machine/agent/run-tool.mjs media-index
inputs:
  - name: indexPath
...
```bash
cat experiments/codex-bread-and-butter-blackbox-v1/project/.content-machine/skills/media-index/examples/request.json | \
