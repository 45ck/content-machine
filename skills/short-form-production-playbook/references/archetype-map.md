...
| Lane ID                  | Script Archetype | Default Visual Mode                                              | Use When                                                     | Do Not Add                                   |
| ------------------------ | ---------------- | ---------------------------------------------------------------- | ------------------------------------------------------------ | -------------------------------------------- |
| `stock-b-roll-explainer` | `howto`          | stock/B-roll plus active captions                                | explanation needs real-world visual support                  | unrelated generic montage                    |
...
| `micro-doc-breakdown`    | `howto`          | archival cards, artifacts, timelines, maps, and evidence inserts | topic needs compact documentary mechanism or myth correction | generic B-roll wallpaper, static slide holds |
| `animation-explainer`    | `howto`          | generated/simple animation scenes                                | abstract concept needs visual metaphor                       | static slide deck                            |
| `motion-card-lesson`     | `howto`          | designed cards with motion accents                               | compact lesson or framework                                  | long unchanged cards                         |
...
8. `micro-doc-breakdown`
9. `animation-explainer`
10. `motion-card-lesson`
11. `ugc-avatar`
