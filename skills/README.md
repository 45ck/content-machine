...
| Longform to vertical clips       | [`longform-to-shorts/`](longform-to-shorts/SKILL.md)                                                                                                                                                 | `source-media-analyze -> longform-highlight-select -> boundary-snap -> highlight-approval -> video-render -> publish-prep-review`                                                              |
