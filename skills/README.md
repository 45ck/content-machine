...
| Longform to vertical clips       | [`longform-to-shorts/`](longform-to-shorts/SKILL.md) and [`longform-to-shorts.flow`](../flows/longform-to-shorts.flow)                                                                               | `source-media-analyze -> longform-highlight-select -> boundary-snap -> highlight-approval -> longform-clip-extract -> video-render -> publish-prep-review`                                     |
...
- [`longform-to-shorts/`](longform-to-shorts/SKILL.md) — transcript-led
  ...
  from long video
- [`longform-clip-extract/`](longform-clip-extract/SKILL.md) — cut
  approved longform candidates into clip-local video, audio, timestamps,
  visuals, and clip-plan artifacts
