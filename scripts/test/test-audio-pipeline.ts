  ...
  scenes: [
    {
      ...
      visualDirection: 'Office setting',
    },
    {
      id: 'scene-2',
      text: 'This is the first point we want to cover.',
      visualDirection: 'Charts and graphs',
    },
    {
      id: 'scene-3',
      text: 'And here is the second important point.',
      visualDirection: 'Team collaboration',
    },
  ],
