...
- **CLI-first + artifacts:** every new capability emits JSON artifacts, not hidden state (see `docs/dev/architecture/SYSTEM-DESIGN-20260104.md`).
...
- **TDD + V&V:** every gate is testable deterministically (Layer 2) and optionally judgeable (Layer 3) (see `docs/dev/guides/VV-FRAMEWORK-20260105.md`).
...
Reference: `docs/research/quality-gates/FAISS-20260106.md` and plan: `docs/dev/architecture/IMPL-RETRIEVAL-MEMORY-FAISS-20260107.md`.
...
- `cm score`: plan-only for now; aligns with `docs/dev/architecture/IMPL-ENGAGEMENT-PROXY-SCORING-20260107.md`.
