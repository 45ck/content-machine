...
- `npm i -g @45ck/content-machine` or `npx -y @45ck/content-machine`
...
- Feature spec: `docs/dev/features/feature-on-demand-assets-20260111.md`
- CLI UX standards: `docs/dev/guides/guide-cli-ux-standards-20260106.md`
- Errors + fix lines: `docs/dev/guides/guide-cli-errors-and-fix-lines-20260107.md`
- Existing code:
  - `src/audio/asr/index.ts`
  - `src/hooks/resolve.ts`
  - `src/render/assets/remote-assets.ts`
