...
- Per-command UX standards docs (`docs/dev/guides/guide-cli-ux-standards-20260106.md`)
...
From `docs/dev/guides/guide-cli-ux-standards-20260106.md`:
...
Reference: `docs/dev/guides/guide-cli-stdout-stderr-contract-20260107.md`.
...
Reference: `docs/dev/features/feature-cli-progress-events-20260106.md`.
...
Pattern inspired by Wrangler/Vercel/Firebase, and consistent with `docs/dev/guides/guide-cli-ux-standards-20260106.md:108`.
...
Reference: `docs/dev/guides/guide-cli-ux-cm-generate-20260106.md`.
