...
| `reddit-post-over-gameplay` | `default`  | Default generic Reddit story mode with a first-class proving MP4.        | `AITA for exposing my roommate's fake job offer to our landlord?`                  |

## Family: Story Lanes

| Lane                        | Status         | Skill now                                                                                                                                                      | Main gap                                                                        | First proving example                                                                        |
| --------------------------- | -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| `reddit-post-over-gameplay` | `skill-backed` | [`reddit-post-over-gameplay-short`](../../skills/reddit-post-over-gameplay-short/SKILL.md), [`reddit-card-overlay`](../../skills/reddit-card-overlay/SKILL.md) | Has first-class full-gameplay proving render; OCR active-word handling remains. | `AITA for exposing my roommate's fake job offer to our landlord?`                            |
...
| `micro-doc-breakdown`        | `skill-backed` | [`micro-doc-breakdown-short`](../../skills/micro-doc-breakdown-short/SKILL.md), [`animation-explainer-short`](../../skills/animation-explainer-short/SKILL.md), [`faceless-mixed-short`](../../skills/faceless-mixed-short/SKILL.md) | Has first proving render; OCR caption-sync still needs P95 drift cleanup. | `How Blockbuster actually died.`                                           |
