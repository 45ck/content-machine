...
| --------------------------- | ------------------------ | ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------ | ---------------------------------------------------------- |
| `reddit-post-over-gameplay` | `showcase candidate`     | Reddit/story post over full-screen gameplay; default story choice, but OCR caption-sync still needs a clean pass | [`reddit-post-over-gameplay-short`](../../skills/reddit-post-over-gameplay-short/SKILL.md) | [Reddit Post Over Gameplay](examples/reddit-post-over-gameplay.md) | [`demo-9`](../demo/demo-9-reddit-post-over-gameplay.mp4)   |
