# Campaign Recipe 014: Security Product Campaign

## Summary

Use hidden risk reveal, security architecture teardown, failure-mode transparency, and procurement proof.
...
```markdown
# Security Product Campaign Campaign Packet
