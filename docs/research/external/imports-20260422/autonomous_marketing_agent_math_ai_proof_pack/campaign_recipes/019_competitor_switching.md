# Campaign Recipe 019: Competitor Switching Campaign

## Summary

Use switching triggers, migration plan, comparison matrix, risk reversal, and proof cluster.
...
```markdown
# Competitor Switching Campaign Campaign Packet
