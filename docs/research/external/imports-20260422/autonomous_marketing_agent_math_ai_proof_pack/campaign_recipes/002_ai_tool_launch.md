# Campaign Recipe 002: AI Software Tool Launch

## Summary

Use mechanism explanation, demo proof, failure-mode transparency, benchmark clarity, and skeptical-buyer proof.
...
```markdown
# AI Software Tool Launch Campaign Packet
