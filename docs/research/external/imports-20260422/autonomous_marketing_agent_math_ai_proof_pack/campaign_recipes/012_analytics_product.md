# Campaign Recipe 012: Analytics / Dashboard Product

## Summary

Use hidden insight reveal, workflow drama, demo proof, data export trust, and integration gallery.
...
```markdown
# Analytics / Dashboard Product Campaign Packet
