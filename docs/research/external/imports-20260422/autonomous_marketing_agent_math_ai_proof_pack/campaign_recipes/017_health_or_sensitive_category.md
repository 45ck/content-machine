# Campaign Recipe 017: Sensitive Category Campaign

## Summary

Use strict evidence language, plain claims, source-backed education, and avoid personal-attribute targeting.
...
```markdown
# Sensitive Category Campaign Campaign Packet
