...
Use organic discussions and community credibility where available.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Community Proof".
