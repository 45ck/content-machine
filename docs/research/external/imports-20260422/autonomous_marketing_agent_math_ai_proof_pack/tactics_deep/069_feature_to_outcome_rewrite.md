# Tactic 069: Feature-to-Outcome Rewrite
...
Translate every feature into an outcome and proof path.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Feature-to-Outcome Rewrite".
