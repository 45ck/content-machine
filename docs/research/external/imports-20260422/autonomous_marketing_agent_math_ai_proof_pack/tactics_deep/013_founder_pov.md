...
Use a sharp founder/operator point of view to create trust and attention.

## When to use

Use when the founder has credible domain insight.

## When not to use

Do not use empty thought leadership.

## Required inputs

Founder story, category thesis, contrarian insight.
...
Persuasion knowledge, trust research.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Founder-Led POV".
...
Engagement quality, comments, saves, newsletter signups.
