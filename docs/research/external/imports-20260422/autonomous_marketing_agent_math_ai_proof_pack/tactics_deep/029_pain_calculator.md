# Tactic 029: Pain Calculator

## Buyer state

Problem-aware / ROI buyer

## What it does

Let buyer quantify the cost of status quo.

## When to use

Use when pain has measurable time/error/revenue cost.
...
Inputs, assumptions, formulas, caveats.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Pain Calculator".
...
Calculator completion, lead quality, sales conversations.
