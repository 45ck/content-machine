...
Short proof story: before, intervention, after, timeframe.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Micro Case Study".
