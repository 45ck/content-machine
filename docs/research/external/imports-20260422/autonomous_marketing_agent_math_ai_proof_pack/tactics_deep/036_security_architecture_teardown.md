# Tactic 036: Security Architecture Teardown
...
Use a trust page or diagram to show control boundaries.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Security Architecture Teardown".
