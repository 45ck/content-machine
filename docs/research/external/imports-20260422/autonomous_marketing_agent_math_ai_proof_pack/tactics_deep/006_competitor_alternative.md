# Tactic 006: Competitor Alternative

## Buyer state

Active buyer / vendor-aware

## What it does

Intercept buyers comparing alternatives and clarify tradeoffs.

## When to use

Use when buyers already search competitors or categories.

## When not to use

Do not make false comparative claims.

## Required inputs

Feature table, pricing, integrations, customer fit.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Competitor Alternative".
...
Comparison page visits, demo requests, branded search share.
