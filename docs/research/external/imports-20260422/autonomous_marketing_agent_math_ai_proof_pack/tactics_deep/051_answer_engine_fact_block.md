# Tactic 051: Answer Engine Fact Block
...
Create concise facts answer engines can cite.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Answer Engine Fact Block".
