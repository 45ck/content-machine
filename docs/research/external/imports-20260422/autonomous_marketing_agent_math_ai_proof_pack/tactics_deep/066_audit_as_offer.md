...
Offer an audit that naturally leads into the product solution.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Audit Offer".
