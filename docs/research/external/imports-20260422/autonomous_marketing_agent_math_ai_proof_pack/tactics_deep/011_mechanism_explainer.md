# Tactic 011: Mechanism Explainer
...
Explain how the product produces the outcome.

## When to use

Use when buyers distrust black-box promises.

## When not to use

Do not overcomplicate the first screen.

## Required inputs

Architecture, workflow, data flow, product screenshots.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Mechanism Explainer".
...
Demo engagement, docs clicks, trial activation.
