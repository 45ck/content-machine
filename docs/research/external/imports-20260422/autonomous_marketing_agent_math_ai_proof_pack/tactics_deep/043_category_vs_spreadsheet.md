# Tactic 043: Spreadsheet Replacement

## Buyer state

Manual-workflow buyer

## What it does

Frame the old workaround as fragile and expensive.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Spreadsheet Replacement".
