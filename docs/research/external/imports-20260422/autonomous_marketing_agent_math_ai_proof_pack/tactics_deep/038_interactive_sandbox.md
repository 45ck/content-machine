# Tactic 038: Interactive Sandbox

## Buyer state

Skeptical active buyer

## What it does

Let buyers test value before signup or sales call.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Interactive Sandbox".
