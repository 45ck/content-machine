# Tactic 042: Switcher Campaign

## Buyer state

Competitor-aware buyer

## What it does

Target buyers frustrated with incumbent friction.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Switcher Campaign".
