# Tactic 049: Customer Language Mirror
...
Use exact phrases from reviews/interviews to lower mismatch.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Customer Language Mirror".
