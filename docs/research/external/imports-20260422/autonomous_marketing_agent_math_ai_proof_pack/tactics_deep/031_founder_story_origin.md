# Tactic 031: Founder Origin Story
...
Use credible founder pain and origin to make the category human.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Founder Origin Story".
