...
Lead with product proof instead of abstract slides.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Demo Over Deck".
