# Tactic 014: Retargeting Proof Stack
...
Serve proof assets based on previously viewed intent.

## When to use

Use when there is site traffic but low conversion.

## When not to use

Do not spam the same claim repeatedly.

## Required inputs

Page visit segments, objections, proof assets.
...
Measurement research, ad skepticism.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Retargeting Proof Stack".
...
Return visits, conversion lift with holdout, frequency quality.
