...
Turn objections into direct ad and landing-page answers.

## When to use

Use when repeated objections appear in sales/support/reviews.

## When not to use

Do not raise scary objections without resolving them.

## Required inputs

Objection list, proof points, screenshots.
...
Persuasion knowledge, ad skepticism.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Objection FAQ Ads".
...
FAQ engagement, demo conversion, support-question decline.
