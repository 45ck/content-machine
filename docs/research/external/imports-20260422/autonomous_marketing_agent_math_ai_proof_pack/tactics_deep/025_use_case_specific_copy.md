# Tactic 025: Use-Case Specific Copy
...
Make the product feel built for one workflow/persona.

## When to use

Use when generic positioning underperforms.

## When not to use

Do not overfragment too early.

## Required inputs

Persona, task, trigger, desired result.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Use-Case Specific Copy".
...
Landing page CVR by use case, quality lead mix.
