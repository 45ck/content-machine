...
Show where ROI comes from and what assumptions drive it.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "ROI Teardown".
