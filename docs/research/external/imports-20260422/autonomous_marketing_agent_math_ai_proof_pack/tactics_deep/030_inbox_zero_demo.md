# Tactic 030: Inbox-to-Action Demo
...
Show messy inbound information transformed into structured output.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Inbox-to-Action Demo".
