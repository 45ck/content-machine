# Tactic 050: Search Result Ownership

## Buyer state

Research-stage buyer

## What it does

Create pages for category, competitor, alternative, pricing, and integration queries.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Search Result Ownership".
