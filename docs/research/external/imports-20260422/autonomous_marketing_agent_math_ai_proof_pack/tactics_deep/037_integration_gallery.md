# Tactic 037: Integration Gallery

## Buyer state

Stack-sensitive buyer

## What it does

Show the product inside tools the buyer already uses.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Integration Gallery".
