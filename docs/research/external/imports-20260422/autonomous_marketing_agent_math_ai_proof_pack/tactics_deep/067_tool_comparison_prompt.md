# Tactic 067: AI Search Comparison Prompt
...
Seed pages that answer comparison prompts directly.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "AI Search Comparison Prompt".
