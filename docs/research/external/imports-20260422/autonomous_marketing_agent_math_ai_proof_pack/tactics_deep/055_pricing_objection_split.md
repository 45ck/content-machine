# Tactic 055: Pricing Objection Split
...
Separate expensive, unclear, and risky as different pricing objections.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Pricing Objection Split".
