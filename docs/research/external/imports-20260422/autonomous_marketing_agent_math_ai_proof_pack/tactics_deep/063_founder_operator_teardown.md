...
Founder/operator records a real teardown of a broken workflow.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Operator Teardown".
