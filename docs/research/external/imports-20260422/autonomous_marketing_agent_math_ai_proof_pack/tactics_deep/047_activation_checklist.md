# Tactic 047: Activation Checklist
...
Make next steps explicit and finite.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Activation Checklist".
