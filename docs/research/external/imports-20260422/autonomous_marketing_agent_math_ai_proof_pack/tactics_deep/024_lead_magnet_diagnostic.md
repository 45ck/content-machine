# Tactic 024: Lead Magnet Diagnostic
...
Give a useful assessment that reveals problem severity.

## When to use

Use when buyers need education before demo.

## When not to use

Do not make it a thin email trap.

## Required inputs

Diagnostic questions, score logic, recommendations.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Lead Magnet Diagnostic".
...
Completion rate, qualified leads, follow-up conversion.
