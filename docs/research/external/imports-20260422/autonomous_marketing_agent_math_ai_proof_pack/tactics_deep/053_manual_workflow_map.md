# Tactic 053: Manual Workflow Map
...
Diagram current process and show the wasted steps.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Manual Workflow Map".
