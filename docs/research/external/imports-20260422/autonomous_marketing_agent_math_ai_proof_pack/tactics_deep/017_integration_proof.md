...
Prove the product fits the existing stack.

## When to use

Use when compatibility concerns block adoption.

## When not to use

Do not claim integrations that are unstable.

## Required inputs

Integration list, setup steps, screenshots.
...
```text
Using the product facts, buyer language, and proof assets, create 10 ad variants for the tactic "Integration Proof".
...
Integration page visits, trial setup completions.
