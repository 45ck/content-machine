...
The coupon site helped the user discover or decide.

## Conceptual methodology

Users near checkout search for codes; a coupon site captures final-click attribution even when it did not create demand.
...
High conversions with very short time-to-purchase; low new-customer rate; direct traffic converted as affiliate.
