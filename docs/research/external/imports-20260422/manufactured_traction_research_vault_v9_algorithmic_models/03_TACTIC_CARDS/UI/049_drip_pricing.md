...
E-commerce / ticketing / bookings

## What the tactic tries to make outsiders believe

The initial price is the real price.

## Conceptual methodology

Mandatory fees are introduced late, making the product appear cheaper than it is and increasing checkout inertia.
...
Mandatory fees late in checkout; headline price mismatch; fees hidden until payment step.
