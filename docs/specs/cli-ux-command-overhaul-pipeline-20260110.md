...
9. **Progress phase naming contract (H1,H4):** Lock a stable phase vocabulary for each stage (e.g., `research`, `llm`, `tts`, `asr`, `align`, `search`, `download`, `bundle`, `render-media`) so progress feels consistent across runs. (Align with `docs/features/feature-cli-progress-events-20260106.md`.)
