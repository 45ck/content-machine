...
- `cm validate`: verify rendered `video.mp4` meets platform technical constraints and basic visual-quality proxies (see `docs/architecture/IMPL-RENDER-VALIDATION-PIPELINE-20260107.md`).
- `cm score`: compute artifact-based proxy signals (hook/pacing/caption fit) and expose them as a structured report (see `docs/architecture/IMPL-ENGAGEMENT-PROXY-SCORING-20260107.md`).
