...
export const ENVIRONMENT_VARIABLES = [
  ...
  { name: 'CM_MEDIA_VEO_MODEL', required: false },
  ...
  { name: 'BYTEPLUS_API_KEY', required: false },
  { name: 'CM_MEDIA_SEEDANCE_ENDPOINT', required: false },
  { name: 'CM_MEDIA_SEEDANCE_MODEL', required: false },
  ...
  { name: 'ESBUILD_BINARY_PATH', required: false },
